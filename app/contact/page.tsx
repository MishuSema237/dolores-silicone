      ...
      <section className="relative overflow-hidden bg-[#0c0517] text-white py-24 md:py-36">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-purple-200/50 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Have a question about Dolores Silicone or your order? We'd love
            to hear from you.
          </p>
        </div>
      </section>
        ...
        <div className="lg:col-span-7 bg-white p-4 md:p-8 rounded-md md:rounded-2xl shadow-sm border border-purple-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <FormInput
              ...
              label="Subject"
              type="text"
              placeholder="Inquiry about a reborn baby"
              required
        ...
        <div className="lg:col-span-5 space-y-6 md:space-y-8">
          <div className="bg-gradient-to-br from-purple-50 to-white p-4 md:p-8 rounded-md md:rounded-2xl border border-purple-100 shadow-sm">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  <p className="font-semibold text-gray-900 mb-1">Write to Us</p>
                  <a
          ...
          <div className="bg-gradient-to-br from-purple-50 to-white p-4 md:p-8 rounded-md md:rounded-2xl border border-purple-100 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg md:text-xl font-serif text-gray-800">Customer Service Hours</h3>
            </div>
            <div className="space-y-3 text-sm">
              ...
              <p className="text-xs text-gray-400 pt-2 border-t border-gray-100">Hours are in GMT. WhatsApp messages are answered within 24 hours.</p>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-12 md:py-16">
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-2 text-purple-600 mb-3">
            <FaQuestionCircle />
            <span className="font-black uppercase tracking-widest text-sm">Frequently Asked Questions</span>
          </div>
        ...
        <div className="space-y-3">
          {faqs.length > 0 ? faqs.map((faq, i) => (
            ...
            <p className="text-center text-gray-400 py-8">Frequently asked questions coming soon.</p>
          )}
        </div>
      </div>
    </div>
