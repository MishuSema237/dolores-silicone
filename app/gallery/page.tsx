...
export const metadata = {
  ...
  description:
    "Explore a collection of our most beloved creations. Each photo highlights the craftsmanship and realistic detail of our silicone babies.",
};
      ...
      <section className="relative overflow-hidden bg-[#0c0517] text-white py-24 md:py-36">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-purple-200/50 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Explore a collection of our most beloved creations. Each photo
            highlights the craftsmanship and realistic detail of our silicone babies.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-10">
            <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-lg leading-relaxed">
              Every baby in this gallery was hand-painted with 8-20+ layers of heat-set Genesis paints,
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              { step: "01", title: "Sculpting & Preparation", desc: "Sculpt selected, cleaned, sanded, and prepared for painting" },
              { step: "02", title: "Hand Painting", desc: "8-20+ translucent layers of heat-set Genesis paints" },
              { step: "03", title: "Rooting & Styling", desc: "Strand-by-strand mohair and micro-rooted eyelashes" },
              { step: "04", title: "Weighting & Dressing", desc: "Weighted with glass beads and dressed in handmade outfits" },
            ].map((item, i) => (
