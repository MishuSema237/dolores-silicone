...
export const metadata = {
  ...
  description: "Privacy Policy for Dolores Silicone's handcrafted silicone reborn dolls.",
};
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 prose prose-gray max-w-none">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            When you visit {BRAND.name}, we automatically collect certain information about your device, including your web browser, IP address, time zone, and some cookies installed on your device. Additionally, as you browse the site, we collect information about the individual web pages or products you view, which websites or search terms referred you to the site, and how you interact with the site.
          </p>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">We use the Order Information we collect generally to:</p>
          <ul className="list-disc pl-6 text-gray-600 leading-relaxed mb-6 space-y-2">
            <li>Process orders placed through the site (including processing your payment, arranging shipping, and sending invoices and/or order confirmations)</li>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            We share your Personal Information with third parties to help us use your Personal Information, as described above. We also use Google Analytics to help us understand how our customers use the site. We may also share your Personal Information to comply with applicable laws and regulations, respond to a subpoena, search warrant, or other lawful request for information we receive, or to otherwise protect our rights.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">4. Your Rights</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            If you are a European resident, you have the right to access the personal information we hold about you and to ask that your personal information be corrected, updated, or deleted. If you would like to exercise these rights, please contact us through the contact information below.
          </p>
