...
export async function generateMetadata({ params }: ProductPageProps) {
  ...
  const description = product.description || `Buy ${product.name} — a handcrafted silicone reborn doll by Dolores Silicone.`;
  ...
  return {
    ...
    keywords: [
      ...
      "handmade reborn doll",
      "realistic baby doll",
      "platinum silicone reborn",
      "reborn doll for sale",
      product.category === "boys" ? "reborn boy doll" : product.category === "girls" ? "reborn girl doll" : "reborn doll accessories",
    ],
    openGraph: {
      title,
      description,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
        ...
        <div className="lg:col-span-6 px-6 lg:px-0">
          ...
          <div className="mt-6 mb-6">
            <a
              href={`${WHATSAPP.link}?text=${encodeURIComponent(`Hi! I have a question about ${product.name}.`)}`}
              target="_blank"
          ...
          <Accordion>
            ...
            {product.materialsAndCare && (
              <AccordionItem title="Materials and Care">
