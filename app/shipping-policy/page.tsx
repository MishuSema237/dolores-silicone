...
export const metadata = {
  ...
  description: "Shipping information for Dolores Silicone's handcrafted silicone reborn dolls.",
};
      ...
      <section className="relative overflow-hidden bg-[#0c0517] text-white py-24 md:py-36">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-purple-200/50 text-lg md:text-xl max-w-xl mx-auto leading-relaxed mb-4">
            How we deliver your precious handmade baby safely to your door.
          </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 prose prose-gray max-w-none">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            All orders are processed within <strong>1–3 business days</strong>. Orders are not shipped or delivered on weekends or UK public holidays. If we experience a high volume of orders, shipments may be delayed by a few days. We will contact you if there is a significant delay in dispatching your order.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            All UK shipments are made via Royal Mail or a trusted tracked courier service. A tracking number will be provided by email once your order has been dispatched.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">International Shipping</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            We ship to selected international destinations. International shipping rates and delivery times vary by location. Estimated delivery is <strong>7–21 business days</strong> depending on the destination. Please note that customs duties, import taxes, and brokerage fees are the responsibility of the recipient and are not included in shipping charges.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">Packaging</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Every Dolores Silicone reborn baby is carefully packed in a secure, cushioned box to ensure it arrives undamaged. Our packaging is designed to protect the delicate details of each handmade piece during transit. Each baby is wrapped in soft tissue paper and includes a certificate of authenticity.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">Order Tracking</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Once your order has been shipped, you will receive an email with your tracking number. You can track your order on the carrier's website or using our{" "}
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            If your package appears to be lost or arrives damaged, please contact us immediately. We will work with the carrier to investigate and resolve the issue. For damaged shipments, keep all packaging materials and take photographs of the damage.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">Contact Us</h2>
          <p className="text-gray-600 leading-relaxed">
            If you have any questions about shipping, please contact us via our{" "}
