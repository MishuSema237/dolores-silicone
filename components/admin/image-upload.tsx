            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                {value.length < maxFiles && (
                    <div
                        ...
                        className="aspect-square rounded-lg border-2 border-dashed border-gray-300 hover:border-purple-400 cursor-pointer flex flex-col items-center justify-center text-gray-400 hover:text-purple-500 transition-colors bg-gray-50"
                    >
