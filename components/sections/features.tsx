...
const features: Feature[] = [
  {
    icon: <FaHandSparkles className="text-4xl text-pink-500 mb-4" />,
  ...
  {
    icon: <FaGem className="text-4xl text-pink-500 mb-4" />,
  ...
  {
    icon: <FaHeart className="text-4xl text-pink-500 mb-4" />,
