...
export function ShopClient({ initialProducts }: ShopClientProps) {
    ...
    const categoryDescriptions: Record<string, string> = {
        all: "Explore every handmade silicone reborn doll and accessory in our collection. Each one is a unique, one-of-a-kind creation made with medical-grade platinum silicone.",
        girls: "Our handmade silicone baby girls, each painted with an extraordinary level of detail. From delicate eyelashes to weighted bodies that feel like holding a real newborn.",
        boys: "Our handmade silicone baby boys, each a unique masterpiece. Premium platinum silicone, hand-rooted hair, and the realistic weighted feel Dolores Silicone is known for.",
        accessories: "Beautifully crafted accessories to complement your Dolores Silicone baby: from clothing and blankets to bottles and keepsakes.",
    };
            ...
            {filteredProducts.length > 0 ? (
                ...
                <div className="text-center py-12 bg-white rounded-[40px] border-2 border-dashed border-gray-100 flex flex-col items-center">
                    ...
                    <p className="text-gray-500 mb-8 max-w-md">
                        {category === "girls"
                            ? "We're preparing new baby girls. Come back soon or contact us for a custom commission."
                            : category === "boys"
                            ? "We're preparing new baby boys. Come back soon or contact us for a custom commission."
                            : category === "accessories"
                            ? "We're preparing accessories. Contact us on WhatsApp to see what's available."
                            : "Try adjusting your search or filters. Each of our babies is unique and availability changes frequently."}
                    </p>
